...
class GeminiProvider implements AiDiagnosticProvider
{
    ...
    public function diagnose(string $symptoms, string $deviceInfo): AiDiagnosticResult
    {
        ...
        if ($text === '') {
            throw new AiProviderException('invalid_payload', 'No se pudo interpretar la respuesta del servicio IA.');
        }
        ...
        return AiDiagnosticResult::fromPayload($normalized, 'gemini', $tokensUsed);
    }
